...
namespace winrt::WinUIMinGW::implementation {
    ...
    IXamlType App::GetXamlType(TypeName const &type) { return provider.GetXamlType(type); }
    IXamlType App::GetXamlType(hstring const &fullname) { return provider.GetXamlType(fullname); }
    com_array<XmlnsDefinition> App::GetXmlnsDefinitions() { return provider.GetXmlnsDefinitions(); }
} // namespace winrt::WinUIMinGW::implementation